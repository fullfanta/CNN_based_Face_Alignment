...
def get_symbol(num_classes=136):
    ## define alexnet
    ...
    loc_loss = mx.symbol.LinearRegressionOutput(data=fc8, label=label, name="loc_loss")
    #loc_loss_ = mx.symbol.smooth_l1(name="loc_loss_", data=(fc8 - label), scalar=1.0)
    #loc_loss_ = mx.symbol.smooth_l1(name="loc_loss_", data=fc8, scalar=1.0)
